...
function JobsTabComponent() {
	return (
		<div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
			<div>
				<h1 className="text-2xl font-extrabold text-zinc-100 tracking-tight">Your Duty Queue</h1>
				<p className="text-zinc-500 text-sm mt-1">Active instructions and reported tasks.</p>
			</div>
			...
			<div className="mt-8 bg-zinc-900/40 backdrop-blur border border-zinc-800/60 rounded-3xl p-12 flex flex-col items-center text-center border-dashed">
				...
				<p className="text-zinc-600 text-xs mt-2 max-w-xs">
					No active requests have been dispatched to your sector yet. Grab a coffee! ☕️
				</p>
			</div>
		</div>
	);
